...
const HeroSection = () => {
  ...
  return (
    ...
    <section
      className="flex min-h-screen flex-col items-start justify-center gap-4 bg-cover bg-center px-6 pt-28 pb-16 md:px-16 lg:px-36"
      style={{
        backgroundImage: `linear-gradient(to right, rgba(9, 9, 11, 0.25), rgba(9, 9, 11, 0.20)), url(${assets.backgroundImage})`,
      }}
    >
      <img
      ...
      <div className="flex items-center gap-4 text-gray-300">
        <span>Adventure | Sci-Fi | Action</span>

        <div className="flex items-center gap-1">
          <Calendar1Icon className="h-4.5 w-4.5" />
          2026
        </div>
      ...
      <p className="max-w-md text-gray-300">
        Peter Parker begins a new chapter as Spider-Man, facing powerful
        challenges, unexpected allies, and threats that could change the future
        of New York forever.
      </p>
